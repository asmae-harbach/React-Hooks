...
function MovieCard(props){
    ...
    const handleClick = (e) => {
        e.preventDefault();
        navigate(`/description/${props.titre}`);
      };
    ...
    <a onClick={handleClick} className="flex flex-col items-center bg-gray-300 border border-gray-200 rounded-lg shadow-sm sm:flex-row md:max-w-sm md:h-72 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
